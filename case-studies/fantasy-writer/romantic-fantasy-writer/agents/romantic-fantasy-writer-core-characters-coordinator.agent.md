...
|------|-----------|--------|
| agents/protagonist-profiler/status.json | missing | dispatch romantic-fantasy-writer-protagonist-profiler |
| agents/protagonist-profiler/status.json | result == 'completed' | dispatch romantic-fantasy-writer-romance-arc-designer |
| agents/protagonist-profiler/status.json | result == 'blocked' | write own status: blocked |
| agents/romance-arc-designer/status.json | result == 'completed' | write own status: complete |
| agents/romance-arc-designer/status.json | result == 'blocked' | write own status: blocked |

## Artifact Assignments

**Reads:** story-concept.json, world-bible/geography.json, world-bible/culture.json, agents/protagonist-profiler/status.json, agents/romance-arc-designer/status.json
**Writes:** agents/core-characters-coordinator/status.json
