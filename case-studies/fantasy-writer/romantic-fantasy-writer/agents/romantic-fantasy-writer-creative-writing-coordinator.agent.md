...
|------|-----------|--------|
| agents/chapter-drafter/status.json | missing | dispatch romantic-fantasy-writer-chapter-drafter for current chapter |
| agents/chapter-drafter/status.json | result == 'completed' | dispatch romantic-fantasy-writer-pov-voice-maintainer for current chapter |
| agents/chapter-drafter/status.json | result == 'blocked' | write own status: blocked |
| agents/pov-voice-maintainer/status.json | result == 'completed' | write own status: complete |
| agents/pov-voice-maintainer/status.json | result == 'blocked' | write own status: blocked |

## Artifact Assignments

**Reads:** chapter-outlines/{N}.json, style-guide.json, characters/{CHAR-NNN}.json, agents/chapter-drafter/status.json, agents/pov-voice-maintainer/status.json
**Writes:** agents/creative-writing-coordinator/status.json
