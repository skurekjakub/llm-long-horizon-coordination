...
name: romantic-fantasy-writer-ensemble-coordinator
...
|------|-----------|--------|
| agents/supporting-cast-developer/status.json | missing | dispatch romantic-fantasy-writer-supporting-cast-developer |
| agents/supporting-cast-developer/status.json | result == 'completed' | dispatch romantic-fantasy-writer-character-voice-designer |
| agents/supporting-cast-developer/status.json | result == 'blocked' | write own status: blocked |
| agents/character-voice-designer/status.json | result == 'completed' | write own status: complete |
| agents/character-voice-designer/status.json | result == 'blocked' | write own status: blocked |

## Artifact Assignments

**Reads:** story-concept.json, characters/index.json, agents/supporting-cast-developer/status.json, agents/character-voice-designer/status.json
**Writes:** agents/ensemble-coordinator/status.json
