...
|------|-----------|--------|
| agents/geography-builder/status.json | missing | dispatch romantic-fantasy-writer-geography-builder |
| agents/geography-builder/status.json | result == 'completed' | dispatch romantic-fantasy-writer-culture-builder |
| agents/geography-builder/status.json | result == 'blocked' | write own status: blocked |
| agents/culture-builder/status.json | result == 'completed' | dispatch romantic-fantasy-writer-history-builder |
| agents/culture-builder/status.json | result == 'blocked' | write own status: blocked |
| agents/history-builder/status.json | result == 'completed' | write own status: complete |
| agents/history-builder/status.json | result == 'blocked' | write own status: blocked |

## Artifact Assignments

**Reads:** story-concept.json, agents/geography-builder/status.json, agents/culture-builder/status.json, agents/history-builder/status.json
**Writes:** agents/physical-world-coordinator/status.json
