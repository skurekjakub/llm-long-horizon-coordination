# TASK-005: Update external authentication page
...
|-------|-------|
| **Task ID** | `TASK-005` |
| **Title** | Update external authentication page |
| **Target Page** | `developers-and-admins/development/registration-and-authentication/external-authentication.md` |
| **Action** | `update` |
| **Content Type** | `howto` |
...
| **Related Impacts** | `IMP-003` |

## Description

Replace AddIdentity<ApplicationUser, NoOpApplicationRole> with ApplicationRole and AddRoleStore<NoOpApplicationRoleStore> with ApplicationRoleStore in code samples.

## Scope (from Impact Matrix)

### IMP-003: External authentication
...
- Replace AddRoleStore<NoOpApplicationRoleStore> with ApplicationRoleStore.

## Sections

### Sections to Modify

- AddIdentity code sample (line ~48)
- AddRoleStore code sample (line ~53)
...
- **AREA-001**: NoOpApplicationRole/NoOpApplicationRoleStore replaced with ApplicationRole/ApplicationRoleStore.
- **AREA-002**: ApplicationRole is a concrete role type used for member role management.
...
1. Both code sample locations updated: NoOpApplicationRole → ApplicationRole
2. NoOpApplicationRoleStore → ApplicationRoleStore
3. Code samples are compile-ready (INV-codesamples-010)
4. Backtick formatting on type names (INV-formatting-004)

## Writer Instructions

### Updating an Existing Page

1. Open `developers-and-admins/development/registration-and-authentication/external-authentication.md`
